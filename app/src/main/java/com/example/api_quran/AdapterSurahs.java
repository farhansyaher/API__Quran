...
public class AdapterSurahs extends RecyclerView.Adapter<AdapterSurahs.SurahViewHolder> {
    ...
    public class SurahViewHolder extends RecyclerView.ViewHolder {
        ...
        public SurahViewHolder(@NonNull View itemView) {
            super(itemView);
            textViewSurahLatin = itemView.findViewById(R.id.tvLatinSurah);
            textViewTerjemahanSurah = itemView.findViewById(R.id.tvArtiSurah);
            textViewSurahArab = itemView.findViewById(R.id.tvArabSurah);
